    ...
    <aside class="w-72 bg-white shadow-2xl flex flex-col justify-between rounded-r-3xl">
            <div>
                <div class="p-8 border-b">
                    <span class="text-4xl font-extrabold text-green-700 tracking-tight">Student Filing System</span>
            ...
            <div class="p-8 border-t">
                <span class="text-xs text-gray-400">Created by DatTechGee </span>
            </div>
        </aside>

        <!-- Main Hero -->
        <main class="flex-1 flex flex-col items-center justify-center p-10">
            <div class="bg-white rounded-2xl shadow-2xl p-12 max-w-2xl w-full text-center border border-green-100">
                ...
                <h1 class="text-5xl font-extrabold text-green-700 mb-4 tracking-tight">Student Filing System</h1>
                <p class="text-xl text-gray-600 mb-8">A modern portal for managing student records, requirements, and uploads. Secure, fast, and easy to use for admins and students.</p>
