...
<head>
    ...
    <title>Student Filing System</title>
...
<body class="antialiased bg-gradient-to-br from-green-100 via-white to-blue-100 min-h-screen">
    <div class="flex flex-col md:flex-row min-h-screen">
        ...
        <x-sidebar title="Student Filing System" footer="Created by DatTechGee">
            <a href="#purpose" class="py-3 px-4 rounded hover:bg-green-100 font-semibold text-green-700 flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-green-500" aria-current="page" tabindex="0">
                <span class="text-lg">
            ...
            <a href="#services" class="py-3 px-4 rounded hover:bg-green-100 flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-green-500" tabindex="0">
                <span class="text-lg">
    ...
    <main class="flex-1 flex flex-col items-center justify-center p-4 md:p-10 animate-site-fade-in">
            <div class="bg-white rounded-2xl shadow-2xl p-4 md:p-12 max-w-full md:max-w-2xl w-full text-center border border-green-100">
                <svg viewBox="0 0 62 65" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-20 w-auto mx-auto mb-6">
                ...
                <h1 class="text-3xl md:text-5xl font-extrabold text-green-700 mb-4 tracking-tight">Student Filing System</h1>
                <p class="text-base md:text-xl text-gray-600 mb-8">A modern portal for managing student records, requirements, and uploads. Secure, fast, and easy to use for admins and students.</p>
                <div class="flex flex-col md:flex-row gap-4 md:gap-6 justify-center mb-10">
                    <a href="{{ route('admin.login') }}" class="bg-gradient-to-r from-green-500 to-green-700 text-white px-4 md:px-8 py-3 md:py-4 rounded-xl shadow-lg hover:scale-105 hover:from-green-600 hover:to-green-800 transition-all font-bold text-base md:text-lg">Admin Login</a>
                    <a href="{{ route('student.login') }}" class="bg-gradient-to-r from-blue-500 to-blue-700 text-white px-4 md:px-8 py-3 md:py-4 rounded-xl shadow-lg hover:scale-105 hover:from-blue-600 hover:to-blue-800 transition-all font-bold text-base md:text-lg">Student Login</a>
                </div>
                    ...
                    <ul class="text-left text-gray-700 list-disc list-inside text-base md:text-lg space-y-2">
