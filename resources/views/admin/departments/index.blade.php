...
<div class="min-h-screen bg-gradient-to-br from-green-100 via-white to-blue-100 flex">
  ...
  <main class="flex-1 flex flex-col items-center justify-center p-10">
    <div class="bg-white rounded-2xl shadow-2xl p-10 max-w-3xl w-full border border-green-100">
      <h2 class="text-3xl font-bold text-green-700 mb-6">Departments</h2>
      <a href="{{ route('departments.create') }}" class="bg-gradient-to-r from-green-500 to-green-700 text-white px-8 py-3 rounded-xl shadow-lg font-bold text-lg hover:scale-105 transition-all mb-6 inline-block">Add Department</a>
      <table class="w-full border rounded-xl overflow-hidden shadow">
        <thead>
          <tr class="bg-green-100 text-green-700">
            <th class="p-3 border">Faculty</th>
        ...
        <tbody>
          ...
          <tr class="hover:bg-green-50">
            ...
            <td class="border p-3 flex gap-2">
              <a href="{{ route('departments.edit',$d) }}" class="inline-flex items-center px-3 py-2 bg-gradient-to-r from-blue-500 to-blue-700 text-white rounded-lg shadow hover:scale-105 transition-all" title="Edit">
