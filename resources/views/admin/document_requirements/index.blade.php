        ...
        <tbody>
          ...
          <tr class="hover:bg-green-50">
            ...
            <td class="border p-3 flex gap-2">
              <a href="{{ route('document-requirements.edit',$r) }}" class="inline-flex items-center px-3 py-2 bg-gradient-to-r from-blue-500 to-blue-700 text-white rounded-lg shadow hover:scale-105 transition-all" title="Edit">
