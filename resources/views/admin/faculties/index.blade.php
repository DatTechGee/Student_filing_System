  ...
  <aside class="w-64 bg-white shadow-lg flex flex-col justify-between">
    <div>
      ...
      <nav class="mt-4 flex flex-col gap-2 px-6">
        ...
        <a href="{{ route('faculties.index') }}" class="py-2 px-3 rounded bg-green-100 font-semibold text-green-700 flex items-center gap-2"><span class="text-lg">🏫</span> Faculties</a>
