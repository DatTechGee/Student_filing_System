  ...
  <aside class="w-72 bg-white shadow-2xl flex flex-col justify-between rounded-r-3xl">
    <div>
      ...
      <nav class="mt-8 flex flex-col gap-2 px-8">
        ...
        <a href="{{ route('faculties.index') }}" class="py-3 px-4 rounded bg-green-100 font-semibold text-green-700 flex items-center gap-2"><span class="text-lg">🏫</span> Faculties</a>
    ...
    <div class="p-8 border-t">
      <span class="text-xs text-gray-400">Add Faculty</span>
    </div>
  </aside>
  <!-- Main Content -->
